...
MODEL_ARCH = {
    ...
    "fbnet_mnist_mk1": {
        "block_op_type": [
            ...
            ["ir_k5_e6"], ["ir_k5_e6"], ["ir_k3_e6"], ["ir_k5_e3"],
            ["ir_k5_e6"], ["ir_k5_e6"], ["ir_k5_e6"], ["ir_k3_e6"],
            ["ir_k3_e6"], ["ir_k3_e6"], ["ir_k3_e3"], ["skip"],
            ["ir_k3_s2"],
        ],
        "block_cfg": {
            "first": [16, 2],
            "stages": [
                ...
                [[6, 112, 1, 1]], [[6, 112, 1, 1]], [[6, 112, 1, 1]], [[6, 112, 1, 1]], # stage 5
                [[6, 184, 1, 2]], [[6, 184, 1, 1]], [[3, 184, 1, 1]], [[1, 184, 1, 1]], # stage 6
                [[1, 352, 1, 1]],                                                       # stage 7
            ],
            "backbone": [num for num in range(23)],
        },
    ...
    "fbnet_mnist_mk2": {
        ...
        "block_cfg": {
            ...
            "backbone": [num for num in range(8)],
        },
    },
    "fbnet_mnist_mk3": {
        "block_op_type": [
            ["ir_k3_e3"], ["ir_k5_s2"], 
            ["ir_k5_e6"], ["shift_5x5"], ["ir_k5_e1"],
            ["ir_k3_e6"], 
            ["ir_k3_e3"], 
        ],
        "block_cfg": {
